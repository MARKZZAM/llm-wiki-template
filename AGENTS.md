...
예: `ai-agents/`, `rag-systems/`, `theology/`
...
- 설교: 핵심 메시지, 적용, 예화, 결단 중심
- 주석: 원어 분석, 문맥 해설, 신학적 의의 중심
...
### 파일명
- 한국어 + 하이픈 (`창세기-1장-호크마-주석.md`, `RAG-접근법-비교.md`)
...
- 예: `[[창세기-1장-호크마-주석]]`, `[[design-md-완전-정복]]`
- 파일명이 곧 고유 식별자. 별도 ID 불필요

**raw 파일 참조**: `[[raw/원본파일명.확장자]]` — 경로·확장자 포함
- 예: `[[raw/호크마 주석, 창세기 01장 - 호크마 주석.md]]`
